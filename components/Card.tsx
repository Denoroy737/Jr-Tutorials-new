        ...
        return slug && (
          <Link href={`/Course/${encodeURIComponent(slug.current)}`} key={_id}>
            <div className='my-3 md:w-93 hover:bg-[hsl(0,0%,16%)] bg-[#212121] rounded-xl'>
              <Image src={urlFor(mainImage).url()} alt={title} width={310} height={400} className="rounded-t-xl w-full h-[180px] " />
              <div className="p-4 md:p-5 rounded-b-xl">
                ...
                <p className=' md:text-lg text-gray-300'>Lorem ipsum dolor sit amet.</p>
              </div>
            </div>
          </Link>
        );
