...
const Headline = (props: { Title: string }) => {
    return (
        <div className='flex items-center justify-between space-x-2'>
            ...
            <div>
                <div className="md:flex hidden md:flex-row flex-col items-center md:space-x-3">
                    ...
                    <div className='flex flex-row space-x-2 justify-center py-1 px-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 rounded-full'>
                        <div className="md:p-2 p-1.5 bg-pink-200 w-10 md:w-11 rounded-full">
                ...
                <div className="block md:hidden">
                    ...
                    <Popover isBordered disableShadow>
                        <Popover.Trigger>
                            <Button css={{ background: '#202020', color: 'White' }} auto flat>Filter</Button>
                        </Popover.Trigger>
                        <Popover.Content css={{ background: '#202020', width: '160px', display: 'flex', alignItems: 'flex-start' }}>
